            ...
            <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
                ...
                <section className="mt-16 max-w-3xl mx-auto">
                    ...
                    <div className="space-y-4">
                        <FaqItem
                            q="האם אני צריך/ה כרטיס אשראי כדי להתחיל?"
                            a="לא. ההרשמה והתוכנית החינמית לא דורשות כרטיס אשראי. אם תחליטי לשדרג ל-Pro, נבקש פרטי תשלום רק אז."
                        />
                        <FaqItem
                            q="מה קורה אחרי 30 יום של הניסיון?"
                            a="אם תבחרי לא לשדרג, החשבון יחזור לתוכנית Solo Starter (חינם, עד 10 לקוחות פעילים). הנתונים שלך לעולם לא נמחקים."
                        />
                        <FaqItem
                            q="איך עובד החיבור ל-Sumit וחשבונית ירוקה?"
                            a="במסך ההגדרות תכניסי את מפתחות ה-API שלך מהשירות. המערכת תיצור עבורך הצעות מחיר וחשבוניות ישירות באמצעות החשבון שלך — אנחנו לא לוקחים עמלה על זה."
                        />
                        <FaqItem
