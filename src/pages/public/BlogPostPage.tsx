        ...
        body: () => (
            <>
                ...
                <div className="bg-background border border-border rounded-xl p-5 my-6 text-sm leading-relaxed text-text-secondary">
                    ...
                    <p className="mb-3">בקשה קטנה: אני בונה את דף ההמלצות באתר, ואשמח לכמה משפטים מכם על איך הייתה החוויה. זה עוזר ללקוחות חדשים להחליט, ובעיקר עוזר לי לקבל לקוחות שדומים לכם.</p>
                    <p className="mb-3">אפשר לכתוב כאן בוואטסאפ — אני כבר אדאג להעלות לאתר, עם תמונה של [שם הכלב] אם זה בסדר.</p>
                    <p>תודה רבה!</p>
                </div>
                <p className="text-text-secondary leading-relaxed mb-6">
                ...
                <p className="text-text-secondary leading-relaxed mb-6">
                    חשוב: היעדר תגובה לא אומר שהלקוח לא מרוצה. בגיל המידע, אנשים מקבלים עשרות הודעות ביום ושוכחים לענות לחצי מהן. עצם זה שלקוח עבר את כל הקורס וסיים בלי תלונות = הוא מרוצה. אם רק 3 מתוך 10 לקוחות יענו — זה עדיין שיעור יוצא דופן ביחס לעלות.
                </p>

                <h2 className="text-2xl font-bold text-text-primary mt-10 mb-4">המלצה כתובה מול וידאו</h2>
                <p className="text-text-secondary leading-relaxed mb-4">
                    יש מאלפים שמבקשים סרטון וידאו במקום טקסט. שיעור ההסכמה נמוך משמעותית (15-25% מול 70-80% לטקסט), אבל ההמלצה החזותית שווה פי שלושה.
                </p>
                <p className="text-text-secondary leading-relaxed mb-6">
                    הניסוח שעובד: "אם נוח לכם, סרטון של 30 שניות עם הכלב — מה השתנה אצלכם — שווה לי הרבה יותר מטקסט. גם בלי לראות פנים, רק את הכלב". הירידה בחיכוך (לא צריך להסתיר פנים, לא צריך להיות במקום מסוים) מעלה את ההסכמה.
                </p>

                <h2 className="text-2xl font-bold text-text-primary mt-10 mb-4">המלצות שלא לבקש — והסכנה</h2>
                <p className="text-text-secondary leading-relaxed mb-4">
                    יש לקוחות שעדיף לא לבקש מהם המלצה. שלוש קבוצות:
                </p>
                <ul className="text-text-secondary leading-relaxed mb-6 list-disc list-inside space-y-2 mr-4">
                    <li><strong>לקוחות שלא היו מרוצים</strong> — ברור. אם מהקורס יצאתם בתחושה שמשהו לא הסתדר, הבקשה תיצור אי-נוחות. במקום זה — שיחה כנה לסיכום ולמידה.</li>
                    <li><strong>לקוחות שלא סיימו את החבילה</strong> — נשרו, או הפסיקו באמצע. אין להם תמונה מלאה. ההמלצה תהיה חלקית, ועלולה להיראות מאולצת.</li>
                    <li><strong>חברים קרובים / משפחה</strong> — קוראים מזהים. המלצה שנראית "מקורבת" פוגעת באמינות של דף ההמלצות כולו. בלי שמות פיקטיביים, בלי טריקים.</li>
                </ul>
                <p className="text-text-secondary leading-relaxed mb-6">
                    שלוש המלצות אמיתיות מלקוחות אמיתיים שווה יותר מעשר המלצות שנראות מפוקפקות.
                </p>
    ...
    'late-cancellation-policy': {
        ...
        body: () => (
            <>
                ...
                <h2 className="text-2xl font-bold text-text-primary mt-10 mb-4">המקרים המיוחדים — איך לדבר עליהם מראש</h2>
                <p className="text-text-secondary leading-relaxed mb-4">
                    שלושה מקרים שצצים בכל עסק אילוף, ושכדאי לסכם עליהם בשיחה הראשונה — לפני שהם קורים:
                </p>
                <ul className="text-text-secondary leading-relaxed mb-6 list-disc list-inside space-y-2 mr-4">
                    <li><strong>גשם / מזג אוויר</strong> — האם מפגש בחוץ מבוטל? האם עוברים לבית? יש מאלפים שמכריזים "בגשם — מעבר לבית, אין ביטול". אחרים אומרים "ביטול עד שעתיים לפני בחינם". העיקר: לא להחליט בזמן הגשם.</li>
                    <li><strong>הכלב חולה</strong> — מקרה רגיש. ההמלצה הרווחת: ביטול בלי קנס אם יש אישור וטרינר; אחרת — לפי המדיניות הרגילה. זה גם מסנן ניסיונות לא-כנים.</li>
                    <li><strong>ביטול מצד המאלף</strong> — מה קורה כשאתם צריכים לבטל? לכלול בהצעה: "במקרה של ביטול מצדנו, נציע מועד חלופי תוך שבוע, או החזר מלא". סימטריה בונה אמון.</li>
                </ul>

                <h2 className="text-2xl font-bold text-text-primary mt-10 mb-4">איך תזכורות אוטומטיות מקטינות ביטולים</h2>
                <p className="text-text-secondary leading-relaxed mb-6">
                    הסיבה הנפוצה ביותר לביטול-ברגע-האחרון היא לא חוסר רצון — אלא שכחה. תזכורת ב-WhatsApp 24 שעות לפני המפגש מורידה את שיעור הביטולים מ-8-12% למתחת ל-3%, בלי שום מאמץ נוסף.
                    זה ההבדל בין מאלף שמסתכל ביומן בכל בוקר ושולח תזכורות ידנית (וזוכר לפעמים), לבין מאלף עם תזכורות אוטומטיות שיוצאות בכל מקרה — גם בסופ"ש, גם בחג, גם כשהוא חולה. תזכורת אוטומטית = פחות ביטולים = פחות מקרים שצריך לאכוף את המדיניות בכלל.
                </p>
