        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12">
                    <h1 className="text-4xl font-black text-slate-800 mb-2">מדיניות פרטיות</h1>
                    <p className="text-slate-500 mb-8">עודכן לאחרונה: {lastUpdated}</p>

                    <div className="prose prose-slate max-w-none">
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">1. הקדמה</h2>
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">2. המידע שאנו אוספים</h2>
                            <p className="text-slate-600 leading-relaxed mb-4">אנו אוספים את סוגי המידע הבאים:</p>

                            <h3 className="text-lg font-semibold text-slate-700 mb-2">2.1 פרטי חשבון</h3>
                            ...
                            <h3 className="text-lg font-semibold text-slate-700 mb-2">2.2 נתונים עסקיים</h3>
                            <ul className="list-disc list-inside text-slate-600 space-y-2 mb-4">
                            ...
                            <h3 className="text-lg font-semibold text-slate-700 mb-2">2.3 נתוני Google API</h3>
                            <p className="text-slate-600 leading-relaxed">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">3. כיצד אנו משתמשים במידע שלכם</h2>
                            <p className="text-slate-600 leading-relaxed mb-4">אנו משתמשים במידע שלכם כדי:</p>
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">4. אחסון נתונים ואבטחה</h2>
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">5. שיתוף נתונים</h2>
                            <p className="text-slate-600 leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">6. הזכויות שלכם</h2>
                            <p className="text-slate-600 leading-relaxed mb-4">יש לכם את הזכות:</p>
                            <ul className="list-disc list-inside text-slate-600 space-y-2">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">7. עוגיות ומעקב</h2>
                            <p className="text-slate-600 leading-relaxed">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">8. פרטיות ילדים</h2>
                            <p className="text-slate-600 leading-relaxed">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">9. שינויים במדיניות זו</h2>
                            <p className="text-slate-600 leading-relaxed">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-slate-800 mb-4">10. צרו קשר</h2>
                            <p className="text-slate-600 leading-relaxed">
