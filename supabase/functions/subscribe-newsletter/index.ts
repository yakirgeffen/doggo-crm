...
function renderWelcomeEmail(): string {
    return [
        ...
        '<p style="font-size:15px;line-height:1.6;color:#5C5852;margin:0 0 24px;">תודה על ההרשמה! נשלח מעת לעת טיפים שימושיים על ניהול עסק אילוף — מחירון, שיווק, לקוחות, או תהליכים. בלי ספאם.</p>',
